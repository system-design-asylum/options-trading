use options_trading::{User, Asset, Address};
...
mod tests {
    ...
    fn test_get_balance_nonexistent_asset() {
        ...
        assert_eq!(user.get_balance(&Asset::OTHER("NONEXISTENT".to_string())), 0.0);
    }
    ...
    fn test_multiple_asset_operations() {
        ...
        // Add multiple assets
        user.add_asset(&Asset::BTC, 2.0);
        user.add_asset(&Asset::ETH, 50.0);
        user.add_asset(&Asset::USDT, 1000.0);
